...
public static class TerrainAnalysisUtils {
  ...
  CalculateGradientWithStatus(Mesh mesh, Point3d point, double sampleDistance, out bool calculationFailed) {
  ...
  public static Vector3d GetSteepestDescentDirection(Mesh mesh, Point3d point, double sampleDistance) {
    Vector3d gradient = CalculateGradient(mesh, point, sampleDistance);
  ...
  public static GradientMap PrecomputeGradientMap(Mesh mesh, BoundingBox bbox, double gridSize, double sampleDistance) {
    ...
    for (int i = 0; i < xCount; i++) {
      for (int j = 0; j < yCount; j++) {
        ...
        Vector3d gradient = CalculateGradientWithStatus(mesh, point, sampleDistance, out calculationFailed);
